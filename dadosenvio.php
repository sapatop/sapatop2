    ...
    <header>
          ...
          <div class="card ">
            <div class="card-content ">
              <form method="post" action="">
                <h4 style=" left: 0; width: 100%; text-align: center;">Dados de Envio</h4> 
                <p> 
                <h6 style="color: #674c4c">Nome do Destinatário:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Rua :   </h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">  Número:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Complemento:</h6>
                <input style="margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Bairro:</h6>
                <input style="margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Cidade:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Estado:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Ponto de Referência:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                <h6 style="color: #674c4c">Telefone Celular:</h6>
                <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
        </form>
        </div>  
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col s8 m2">
          <a href="#" class="waves-effect waves-light btn #6a1b9a" style=" left: 0; width: 100%; text-align: center; background-color: #513f36;">Concluir</a>
          </div> 
          <div class="col s2 m5">
          </div> 
        </div>  
