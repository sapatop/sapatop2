  ...
  <body>
    ...
    <header>
      ...
      <ul class="pagination center">
        ...
        <li class="waves-effect"><a href="scarpin2.php">2</a></li>
        <li class="waves-effect"><a href="#!">3</a></li>
        <li class="waves-effect"><a href="#!">4</a></li>
        <li class="waves-effect"><a href="#!">5</a></li>
        <li class="waves-effect"><a href="scarpin2.php"><i class="material-icons">chevron_right</i></a></li>
      </ul>
