...
$result_curso = "SELECT * FROM produtos where id_categoria = 4";
$resultado_curso = mysqli_query($conn, $result_curso);
$total_cursos = mysqli_num_rows($resultado_curso);
$quantidade_pg = 12;
$num_pagina = ceil($total_cursos/$quantidade_pg);
$incio = ($quantidade_pg*$pagina)-$quantidade_pg;
$result_cursos = "SELECT * FROM produtos where id_categoria = 4  limit $incio, $quantidade_pg" ;
		...
		<header>
			...
			<ul class="pagination center">
				<li style="background-color: #c2927c;">
					...
					<a href="anabela1.php?pagina=<?php echo $pagina_anterior; ?>" aria-label="Previous" style="color: white;">
				...
				<li style="background-color: #c2927c;"><a style="color: white;" href="anabela1.php?pagina=<?php echo $i; ?>"><?php echo $i; ?></a></li>
				<?php } ?>
				<li style="background-color: #c2927c;">
					<?php
					if($pagina_posterior <= $num_pagina){ ?>
					<a href="anabela1.php?pagina=<?php echo $pagina_posterior; ?>" aria-label="Previous" style="color: white;">
