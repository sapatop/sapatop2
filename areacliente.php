...
<html>
  ...
  <body>
    ...
    <header>
      ...
      <h2 class="center-align" >Área do Cliente</h2>
      <div class="row">
          ...
          <div class="card ">
            <div class="card-content ">
              <form method="post" action=""> 
                <h4 style=" left: 0; width: 100%; text-align: center;">Dados Financeiros</h4> 
                <p>
                  <h6 style="color: #674c4c">Nome Completo</h6>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;border-radius: 3px;"  type="text" placeholder="nome" />
                </p>
           
       
                <h6 style="color: #674c4c;"  >Endereço completo</h6><!-- <img class="collapsible" style="width:20px;" src="img/seta.png"/> -->
                <div class="content">
                  <label style="color: #674c4c">Nome do Destinatário:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Rua :   </label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">  Número:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Complemento:</label>
                  <input style="margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Bairro:</label>
                  <input style="margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Cidade:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Estado:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Ponto de Referência:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                  <label style="color: #674c4c">Telefone Celular:</label>
                  <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
                </div>
                <p>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col s8 m2">
              <a href="dadoscobranca.php" class="waves-effect waves-light btn #6a1b9a" style=" left: 0; width: 100%; text-align: center; background-color: #513f36;">Continuar</a>
          </div> 
          <div class="col s2 m5">
          </div> 
        </div>  
