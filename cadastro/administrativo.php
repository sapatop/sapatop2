...
<html lang="pt-br">
			...
			<div class="navbar-fixed">
				<nav style="background-color: #faf2ee" >
					<ul id="dropdown1" class="dropdown-content">
						...
						<li class="divider"></li>
						<li><a href="administrativo.php">Conta</a></li>
						<li class="divider"></li>
	...
	<div class="container-fluid">
		<div class="row">
			<h1 class="center" style="color: #4b392e">Dados do Cliente</h1>
			<div class="col s12 m4 l4">
				<div class="card">
					<div class="card-content center">
						<h5><strong  style="color: #4b392e">Dados Bancários</strong></h5>
					</div>
					<div class="card-content">
						<h6><strong  style="color: #4b392e">Nome do Titular:</strong><?php echo $_SESSION['nome_do_titular']; ?></h6>
						<br>
						<br>
						<h6><strong  style="color: #4b392e">Número do Cartão:</strong><?php echo $_SESSION['numero_do_cartao']; ?></h6>
						<br>
						<br>
						<h6><strong  style="color: #4b392e">Válidade:</strong><?php echo $_SESSION['validade']; ?></h6>
						<br>
						<br>
						<h6><strong  style="color: #4b392e">Cód. Segurança:</strong><?php echo $_SESSION['codigo_seg']; ?></h6>
						<br>
						<br>
						<br>
						<br>
			...
			<div class="col s12 m4 l4">
				<div class="card">
					<div class="card-content center">
						<h5><strong  style="color: #4b392e">Informações da Conta</strong></h5>
					</div>
					<div class="card-content">
						<h6><strong  style="color: #4b392e">Nome:</strong><?php echo $_SESSION['nome']; ?></h6>
						<br>
						<br>
						<h6 style="margin-bottom: 15px;"><strong  style="color: #4b392e">E-mail:</strong><?php echo $_SESSION['email']; ?></h6>
						<br>
						<br>
						<br>
						<br>
			...
			<div class="col s12 m4 l4">
				<div class="card">
					<div class="card-content center">
						<h5><strong  style="color: #4b392e">Informações do Usuário</strong></h5>
					</div>
					<div class="card-content">
						<h6><strong  style="color: #4b392e">Cpf:</strong><?php echo $_SESSION['cpf']; ?></h6>
						<br>
						<br>
						<h6><strong  style="color: #4b392e">Telefone:</strong><?php echo $_SESSION['telefone']; ?></h6>
						<br>
						<br>
						<h6><strong  style="color: #4b392e">Cep:</strong><?php echo $_SESSION['cep']; ?></h6>
						<br>
						<br>
						<h6 style="margin-bottom: 30px;"><strong  style="color: #4b392e">Numero da Casa:</strong><?php echo $_SESSION['numero_casa']; ?></h6>
						<br>
						<br>
						<br>
					</div>
		...
		<?php $_SESSION['msg'] = "Área restrita";
