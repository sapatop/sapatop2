  ...
  <body>
    ...
    <header>
      ...
      <ul class="pagination center">
        <li class="waves-effect"><a href="scarpin1.php"><i class="material-icons">chevron_left</i></a></li>
        <li class="waves-effect"><a href="scarpin1.php">1</a></li>
