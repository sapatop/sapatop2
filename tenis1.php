  ...
  <body>
    ...
    <header>
      ...
      <ul class="pagination center">
        ...
        <li class="waves-effect"><a href="tenis2.php"><i class="material-icons">chevron_right</i></a></li>
      </ul>
