    ...
    <header>
      ...
      <div class="row">
        ...
        <div class="col s12 m6">
          <div class="card ">
            <div class="card-content ">
              <form method="post" action="">  
                <h4 style=" left: 0; width: 100%; text-align: center;">Dados de Cobrança</h4> 
          ...
          <p>
            <h6 style="color: #674c4c">Validade</h6>
            <input style=" margin-top: 4px;  border: 1px solid #b2b2b2; -webkit-border-radius: 3px;"  type="text" placeholder="nome" />
          </p>
          <p>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col s8 m2">
          <a href="dadosenvio.php" class="waves-effect waves-light btn #6a1b9a" style=" left: 0; width: 100%; text-align: center; background-color: #513f36;">Continuar</a>
          </div> 
          <div class="col s2 m5">
          </div> 
        </div>  
