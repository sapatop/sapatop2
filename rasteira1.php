  ...
  <body>
    ...
    <header>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col s6 m4 l3">
            <div class="card">
              <div class="card-image">
                <img src="img/rasteirapg1-10.jpg">
              </div>
              <div class="card-content">
                <p>R$140 ou 4x de R$35</p>
              </div>
          ...
          <div class="col s6 m4 l3">
            <div class="card">
              <div class="card-image">
                <img src="img/rasteirapg1-11.jpg">
              </div>
              <div class="card-content">
                <p>R$140 ou 4x de R$35</p>
              </div>
          ...
          <div class="col s6 m4 l3">
            <div class="card">
              <div class="card-image">
                <img src="img/rasteirapg1-12.jpg">
              </div>
              <div class="card-content">
                <p>R$140 ou 4x de R$35</p>
              </div>
      ...
      <ul class="pagination center">
        ...
        <li class="waves-effect"><a href="rasteira2.php">2</a></li>
        <li class="waves-effect"><a href="rasteira2.php"><i class="material-icons">chevron_right</i></a></li>
      </ul>
